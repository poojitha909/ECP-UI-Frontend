...
@Component({
  selector: 'app-discussion-search-list-page',
  templateUrl: './discussion-search-list-page.component.html',
  styleUrls: ['./discussion-search-list-page.component.scss']
})
export class DiscussionSearchListPageComponent implements OnInit, OnDestroy  {
